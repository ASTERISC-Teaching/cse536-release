...
argraw(int n)
{
  switch (n) {
  case 0:
    return mythread()->trapframe->a0;
  case 1:
    return mythread()->trapframe->a1;
  case 2:
    return mythread()->trapframe->a2;
  case 3:
    return mythread()->trapframe->a3;
  case 4:
    return mythread()->trapframe->a4;
  case 5:
    return mythread()->trapframe->a5;
  }
  panic("argraw");
  return -1;
}
...
syscall(void)
{
  ...
  num = mythread()->trapframe->a7;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    // Use num to lookup the system call function for num, call it,
    // and store its return value in p->trapframe->a0
    mythread()->trapframe->a0 = syscalls[num]();
  } else {
