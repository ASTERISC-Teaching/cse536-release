...
KERNELVERSION ?= KERNEL2
CFLAGS += -D$(KERNELVERSION)
...
# CSE 536: Compiling the bootloader
$B/bootloader: $(BIOS) $B/bootloader.ld 
	$(LD) $(LDFLAGS) -T $B/bootloader.ld -o $B/bootloader $(BIOS) 
...
QEMUOPTS1 += -initrd kernel-with-recovery.img
